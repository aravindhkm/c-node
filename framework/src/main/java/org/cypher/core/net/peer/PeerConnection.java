...
public class PeerConnection {
  ...
  @Getter
  @Setter
  private CypherState tronState = CypherState.INIT;
  ...
  public void setChannel(Channel channel) {
    ...
    this.nodeStatistics = CypherStatsManager.getNodeStatistics(channel.getInetAddress());
  }
  ...
  public void onConnect() {
    ...
    if (peerHeadBlockNum > headBlockNum) {
      ...
      setTronState(CypherState.SYNC_COMPLETED);
    }
  }
  ...
  public static boolean needToLog(Message msg) {
    ...
    if (msg instanceof InventoryMessage && ((InventoryMessage) msg)
            .getInventoryType().equals(Protocol.Inventory.InventoryType.CYP)) {
      return false;
    }
