...
public class CypherMessageFactory {

  private static final String DATA_LEN = ", len=";

  public static CypherMessage create(byte[] data) throws Exception {
  ...
  private static CypherMessage create(byte type, byte[] packed) throws Exception {
