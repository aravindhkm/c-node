...
public class HandshakeService {
  ...
  public void processHelloMessage(PeerConnection peer, HelloMessage msg) {
    ...
    CypherNetService.getP2pService().updateNodeId(peer.getChannel(), msg.getFrom().getHexId());
  ...
  private void sendHelloMessage(PeerConnection peer, long time) {
    Node node = new Node(CypherNetService.getP2pConfig().getNodeID(),
        CypherNetService.getP2pConfig().getIp(),
        CypherNetService.getP2pConfig().getIpv6(),
        CypherNetService.getP2pConfig().getPort());
