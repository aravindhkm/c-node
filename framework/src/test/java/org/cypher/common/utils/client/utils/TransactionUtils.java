...
public class TransactionUtils {
  ...
  public static String getTransactionSign(String transaction, String priKey,
    ...
    try {
      ...
      TransactionCapsule cyp = new TransactionCapsule(builder.build());
      cyp.sign(privateKey);
      return JsonFormat.printToString(cyp.getInstance(), selfType);
  ...
  public static TransactionCapsule addTransactionSign(Transaction transaction, String priKey,
    ...
    byte[] privateKey = ByteArray.fromHexString(priKey);
    TransactionCapsule cyp = new TransactionCapsule(transaction);
    cyp.addSign(privateKey, accountStore);
    return cyp;
  }
