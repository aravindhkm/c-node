...
public class RepositoryTest extends BaseTest {
  ...
  public void loopCallTest()
    ...
    Transaction aCyp = TvmTestUtils.generateDeploySmartContractAndGetTransaction(
        ...
        null, engeryLiimt);
    Runtime runtime = TvmTestUtils.processTransactionAndReturnRuntime(aCyp,
    ...
    Transaction bCyp = TvmTestUtils.generateDeploySmartContractAndGetTransaction(
        ...
        null, engeryLiimt);
    runtime = TvmTestUtils.processTransactionAndReturnRuntime(bCyp,
        RepositoryImpl.createRoot(StoreFactory.getInstance()), null);
    Assert.assertNull(runtime.getRuntimeError());
  ...
  public void loopCallTestOldVersion()
    ...
    Runtime runtime = TvmTestUtils.processTransactionAndReturnRuntime(aCyp, rootRepository, null);
    Assert.assertNull(runtime.getRuntimeError());
    ...
    Transaction bCyp = TvmTestUtils.generateDeploySmartContractAndGetTransaction(
        ...
        null);
    rootRepository = RepositoryImpl.createRoot(StoreFactory.getInstance());
    runtime = TvmTestUtils.processTransactionAndReturnRuntime(bCyp, rootRepository, null);
    Assert.assertNull(runtime.getRuntimeError());
