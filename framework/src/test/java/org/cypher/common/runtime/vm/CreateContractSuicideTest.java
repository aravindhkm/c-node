...
contract D {
  ...
  public void testAAfterAllowMultiSignProposal()
    ...
    Runtime aRuntime = TvmTestUtils.processTransactionAndReturnRuntime(aCyp,
    ...
    Runtime bRuntime = TvmTestUtils.processTransactionAndReturnRuntime(bCyp,
        RepositoryImpl.createRoot(StoreFactory.getInstance()), null);
    ...
    Runtime cRuntime = TvmTestUtils.processTransactionAndReturnRuntime(cCyp,
        RepositoryImpl.createRoot(StoreFactory.getInstance()), null);
    ...
    Runtime dRuntime = TvmTestUtils.processTransactionAndReturnRuntime(dCyp,
        RepositoryImpl.createRoot(StoreFactory.getInstance()), null);
