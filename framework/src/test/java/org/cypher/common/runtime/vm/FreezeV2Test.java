...
public class FreezeV2Test {
  ...
  private TVMTestResult freezeV2(
    ...
    if (res == 0) {
      ...
      Assert.assertEquals(
          oldTotalNetWeight + frozenBalance / CYP_PRECISION, dynamicStore.getTotalNetWeight());
      ...
      Assert.assertEquals(oldTronPowerWeight, dynamicStore.getTotalTronPowerWeight());
      Assert.assertEquals(
          oldTotalEnergyWeight + frozenBalance / CYP_PRECISION,
      ...
      Assert.assertEquals(oldTotalEnergyWeight, dynamicStore.getTotalEnergyWeight());
      Assert.assertEquals(
          oldTronPowerWeight + frozenBalance / CYP_PRECISION,
  ...
  private TVMTestResult unfreezeV2(
    ...
    if (res == 0) {
      Assert.assertEquals(
          ...
          newOwner.getFrozenV2BalanceForBandwidth());
      Assert.assertEquals(
          oldTotalNetWeight - unfreezeBalance / CYP_PRECISION, dynamicStore.getTotalNetWeight());
      Assert.assertEquals(oldTotalEnergyWeight, dynamicStore.getTotalEnergyWeight());
      ...
      Assert.assertEquals(oldTotalTronPowerWeight, dynamicStore.getTotalTronPowerWeight());
      Assert.assertEquals(
          oldTotalEnergyWeight - unfreezeBalance / CYP_PRECISION,
          dynamicStore.getTotalEnergyWeight());
    } else {
      Assert.assertEquals(
      ...
      Assert.assertEquals(oldTotalNetWeight, dynamicStore.getTotalNetWeight());
      Assert.assertEquals(
          oldTotalTronPowerWeight - unfreezeBalance / CYP_PRECISION,
          dynamicStore.getTotalTronPowerWeight());
    }
  ...
  private TVMTestResult unDelegateResource(
    ...
    if (oldReceiver != null) {
      ...
      if (res == 0) {
        unDelegateMaxUsage = (long) (amount / CYP_PRECISION
  ...
  private TVMTestResult suicide(byte[] callerAddr, byte[] contractAddr, byte[] inheritorAddr)
    ...
    Assert.assertEquals(
        oldContract.getFrozenBalance(), (oldTotalNetWeight - newTotalNetWeight) * CYP_PRECISION);
    Assert.assertEquals(
