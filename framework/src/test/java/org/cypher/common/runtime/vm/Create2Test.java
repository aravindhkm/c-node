...
public class Create2Test extends VMTestBase {
  ...
  */
  ...
  public void testCreate2()
    ...
    for (int i = 0; i < 3; i++) {
      runtime = TvmTestUtils.processTransactionAndReturnRuntime(cyp, rootRepository, null);
  ...
  private void testJsonRpc(byte[] actualContract, long loop) {
    CypherJsonRpcImpl tronJsonRpc;
    NodeInfoService nodeInfoService;
    nodeInfoService = context.getBean(NodeInfoService.class);
    Wallet wallet = context.getBean(Wallet.class);
    tronJsonRpc = new CypherJsonRpcImpl(nodeInfoService, wallet, manager);
    try {
      String res =
