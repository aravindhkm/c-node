...
public class RpcApiServicesTest {
  ...
  @Test
  public void testGetBurnCyp() {
    EmptyMessage message = EmptyMessage.newBuilder().build();
    assertNotNull(blockingStubFull.getBurnCyp(message));
    assertNotNull(blockingStubSolidity.getBurnCyp(message));
    assertNotNull(blockingStubPBFT.getBurnCyp(message));
  }
  ...
  public void testGetTransactionFromPending() {
    BalanceContract.TransferContract tc =
        BalanceContract.TransferContract.newBuilder()
            ...
            .build();
    TransactionCapsule cyp = new TransactionCapsule(tc, TransferContract);
    BytesMessage message = BytesMessage.newBuilder()
        .setValue(cyp.getTransactionId().getByteString()).build();
