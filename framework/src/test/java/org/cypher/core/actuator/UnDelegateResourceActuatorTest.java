...
public class UnDelegateResourceActuatorTest extends BaseTest {
  ...
  public void delegateBandwidthForOwner() {
    ...
    dbManager.getDynamicPropertiesStore().addTotalNetWeight(delegateBalance / CYP_PRECISION);
  ...
  public void delegateCpuForOwner() {
    ...
    dbManager.getAccountStore().put(receiver, receiverCapsule);
    dbManager.getDynamicPropertiesStore().addTotalEnergyWeight(delegateBalance / CYP_PRECISION);
