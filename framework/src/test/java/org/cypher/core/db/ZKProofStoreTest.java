...
public class ZKProofStoreTest extends BaseTest {
  ...
  @Test
  public void testPut() {
    TransactionCapsule cyp = getTransactionCapsule();
    proofStore.put(cyp.getTransactionId().getBytes(),
            true);
    boolean has = proofStore.has(cyp.getTransactionId().getBytes());
  ...
  public void testGet() {
    ...
    proofStore.put(cyp.getTransactionId().getBytes(),
            true);
    Boolean result = proofStore.get(cyp.getTransactionId().getBytes());
    Assert.assertEquals(true, result);

    proofStore.put(cyp.getTransactionId().getBytes(),
            false);
    result = proofStore.get(cyp.getTransactionId().getBytes());
