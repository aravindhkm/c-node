...
public class P2pEventHandlerImplTest {
  ...
  public void testProcessInventoryMessage() throws Exception {
    ...
    int count = peer.getPeerStatistics().messageStatistics.tronInCypInventoryElement
            .getCount(10);
    ...
    InventoryMessage msg = new InventoryMessage(list, Protocol.Inventory.InventoryType.CYP);

    method.invoke(p2pEventHandler, peer, msg.getSendBytes());

    count = peer.getPeerStatistics().messageStatistics.tronInCypInventoryElement.getCount(10);
    ...
    msg = new InventoryMessage(list, Protocol.Inventory.InventoryType.CYP);
