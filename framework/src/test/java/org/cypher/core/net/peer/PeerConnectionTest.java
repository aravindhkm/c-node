...
public class PeerConnectionTest {
  ...
  public void testOnDisconnect() {
    ...
    Item item = new Item(Sha256Hash.ZERO_HASH, Protocol.Inventory.InventoryType.CYP);
  ...
  public void testNeedToLog() throws Exception {
    ...
    msg = new InventoryMessage(new ArrayList<>(), Protocol.Inventory.InventoryType.CYP);
    f = PeerConnection.needToLog(msg);
    Assert.assertTrue(!f);
