...
public class MessageTest {
  ...
  public void testMessageStatistics() {
    ...
    Message message7 = new Message(MessageTypes.CYP.asByte(), null) {
      @Override
      public Class<?> getAnswerMessage() {
        return null;
      }
    ...
    InventoryMessage message9 = new InventoryMessage(new ArrayList<>(), InventoryType.CYP);
    FetchInvDataMessage message10 = new FetchInvDataMessage(new ArrayList<>(), InventoryType.CYP);
