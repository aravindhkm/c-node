...
public class RepositoryImpl implements Repository {
  ...
  public Pair<Long, Long> getAccountEnergyUsageBalanceAndRestoreSeconds(AccountCapsule accountCapsule) {
    ...
    long balance = (long) ((double) newEnergyUsage * totalEnergyWeight / totalEnergyLimit * CYP_PRECISION);
  ...
  public Pair<Long, Long> getAccountNetUsageBalanceAndRestoreSeconds(AccountCapsule accountCapsule) {
    ...
    long balance = (long) ((double) newNetUsage * totalNetWeight / totalNetLimit * CYP_PRECISION);
  ...
  public void saveTotalTronPowerWeight(long totalTronPowerWeight) {
    updateDynamicProperty(TOTAL_CYPHER_POWER_WEIGHT,
  ...
  public long getTotalTronPowerWeight() {
    return Optional.ofNullable(getDynamicProperty(TOTAL_CYPHER_POWER_WEIGHT))
        .map(BytesCapsule::getData)
        .map(ByteArray::toLong)
        .orElseThrow(
