...
public class DelegateResourceProcessor {
  ...
  public void validate(DelegateResourceParam param, Repository repo) throws ContractValidateException {
    ...
    if (delegateBalance < CYP_PRECISION) {
      throw new ContractValidateException("delegateBalance must be greater than or equal to 1 CYP");
    }
    ...
    switch (param.getResourceType()) {
      case BANDWIDTH: {
        ...
        long netUsage = (long) (ownerCapsule.getNetUsage() * CYP_PRECISION * ((double)
