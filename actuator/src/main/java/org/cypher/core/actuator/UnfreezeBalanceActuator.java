  ...
  public boolean execute(Object result) throws ContractExeException {
    ...
    if (!ArrayUtils.isEmpty(receiverAddress) && dynamicStore.supportDR()) {
      ...
      if (dynamicStore.getAllowTvmConstantinople() == 0 ||
        ...
        switch (unfreezeBalanceContract.getResource()) {
          case BANDWIDTH:
            ...
            if (dynamicStore.getAllowTvmSolidity059() == 1
                ...
                < unfreezeBalance) {
              oldNetWeight = unfreezeBalance / CYP_PRECISION;
          ...
          case ENERGY:
            ...
            if (dynamicStore.getAllowTvmSolidity059() == 1
              ...
              oldEnergyWeight = unfreezeBalance / CYP_PRECISION;
        ...
        decrease = -unfreezeBalance / CYP_PRECISION;
      }
    ...
    long weight = dynamicStore.allowNewReward() ? decrease : -unfreezeBalance / CYP_PRECISION;
    switch (unfreezeBalanceContract.getResource()) {
      case BANDWIDTH:
        dynamicStore
