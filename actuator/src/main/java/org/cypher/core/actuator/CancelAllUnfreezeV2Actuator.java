...
public class CancelAllUnfreezeV2Actuator extends AbstractActuator {
  ...
  public boolean execute(Object result) throws ContractExeException {
    ...
    right representing the pair object corresponding to cypher power. The pair object for each
    ...
    cancelUnfreezeV2AmountMap.put(CYPHER_POWER.name(), triple.getRight().getRight().get());
